...
const columns: ColumnProps<PullLogResponse>[] = [
  ...
  { prop: 'dataType', label: '数据类型', width: 120, enum: [{ label: '订单拉取', value: "ORDER", tagType: 'primary' }, { label: '商品同步', value: "PRODUCT", tagType: 'success' }, { label: '售后同步', value: "REFUND", tagType: 'warning' }] },
  ...
  { prop: 'pullWay', label: '触发方式', width: 100, enum: [{ label: '定时', value: "JOB", tagType: 'info' }, { label: '手动', value: "MANUAL", tagType: 'primary' }] },
