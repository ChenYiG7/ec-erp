...
<template>
  <div class="table-box">
    <ProTable
      ref="proTableRef"
      page-id="/purchase/suppliers"
      title="供应商管理"
      :columns="columns"
      :request-api="supplierApi.page"
    >
      <!-- 工具栏左:新增(按钮权限收口在页面侧 v-auth;toolbarLeft prop 的 auth 属性无效,禁用) -->
      <template #toolbarLeft>
        <el-button v-auth="'purchase:supplier:add'" type="primary" :icon="CirclePlus" @click="openForm('add')"
          >新增供应商管理</el-button
        >
      </template>
      ...
      <template #operation="scope">
        ...
        >
        <el-button
          v-auth="'purchase:supplier:remove'"
          type="danger"
          link
          :icon="Delete"
