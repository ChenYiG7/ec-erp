...
const columns: ColumnProps<AiSuggestionResponse>[] = [
  ...
  { prop: 'suggestionType', label: '建议类型', width: 110, enum: [{ label: '补货', value: "REPLENISH", tagType: 'primary' }, { label: '定价', value: "PRICING", tagType: 'warning' }, { label: '异常', value: "ANOMALY", tagType: 'danger' }, { label: '文案', value: "COPYWRITING", tagType: 'info' }] },
