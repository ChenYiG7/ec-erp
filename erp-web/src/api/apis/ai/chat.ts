...
export const aiChatApi = {
  ...
  pageSessions: (params: AiChatSessionQuery & PageQuery) =>
    http
      .get<PageResult<AiChatSessionResponse>>('/api/ai/chat/sessions', params)
  ...
  chatSync: (sessionId: number, message: string) =>
    http.post<string>(`/api/ai/chat/sessions/${sessionId}/chat-sync`, { message }),
