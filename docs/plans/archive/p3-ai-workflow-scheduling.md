...
> ✅ 已于 2026-09-12 实施(采购/文案/选品三 Job:PurchaseJob/CopywritingJob/SelectionJob,错峰 cron,
> 各自独立开关默认关;拍板与实施细节见 `docs/devlog/2026-09-12-拍板解挂批次(小件五连+调拨在途).md` §3)。
> 2026-09-13 文档整理移入 archive/。
